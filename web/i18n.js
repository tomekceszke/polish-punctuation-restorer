...
const STRINGS = {
  pl: {
    ...
    "demo.note": "Kliknij w ramkę i wpisz własny tekst — model policzy się w Twojej przeglądarce, bez serwera. Rozumie tylko polskie litery; cudzysłowy, myślniki i cyfry znikną, a znaki, które sam wpiszesz, model i tak postawi po swojemu.",
    "demo.working": "model analizuje…",
    "demo.done": "gotowe ✓",
    "demo.placeholder": "Wpisz albo wklej polski tekst bez przecinków…",
    "demo.loading": "pobieram model…",
    "demo.loadingPct": "pobieram model… {pct}%",
    "demo.error": "nie udało się wczytać modelu — odśwież stronę",
    "demo.empty": "najpierw wpisz jakiś tekst",
    "demo.tooLong": "{n} znaków — maksimum to {max}",
    "demo.count": "{n} / {max} znaków",
    "demo.hint": "⌘/Ctrl + Enter",
  ...
  en: {
    ...
    "demo.note": "Click the box and type your own text — the model runs in your browser, with no server involved. It only knows Polish letters; quotes, dashes and digits are dropped, and any punctuation you type is replaced by the model's own.",
    "demo.working": "model is thinking…",
    "demo.done": "done ✓",
    "demo.placeholder": "Type or paste Polish text with no commas…",
    "demo.loading": "downloading the model…",
    "demo.loadingPct": "downloading the model… {pct}%",
    "demo.error": "could not load the model — please reload the page",
    "demo.empty": "type some text first",
    "demo.tooLong": "{n} characters — the limit is {max}",
    "demo.count": "{n} / {max} characters",
    "demo.hint": "⌘/Ctrl + Enter",
